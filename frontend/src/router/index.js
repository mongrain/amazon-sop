...
const layoutChildren = [
    ...
    { path: 'sprints', name: 'sprints', component: SprintsView, meta: { active: 'sprints', title: '冲刺广告' } },
    { path: 'sprints/new', name: 'sprints-new', component: SprintFormView, meta: { active: 'sprints', title: '新建冲刺广告' } },
    { path: 'sprints/:id', name: 'sprint-edit', component: SprintFormView, meta: { active: 'sprints', title: '编辑冲刺广告' } },
