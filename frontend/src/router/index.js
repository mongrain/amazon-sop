...
const layoutChildren = [
    ...
    { path: 'daily-rants', name: 'daily-rants', component: DailyRantsView, meta: { active: 'daily_rants', title: '每日吐槽' } },
    { path: 'daily-rants/new', name: 'daily-rants-new', component: DailyRantEditView, meta: { active: 'daily_rants', title: '写吐槽' } },
    { path: 'daily-rants/:id', name: 'daily-rant-edit', component: DailyRantEditView, meta: { active: 'daily_rants', title: '每日吐槽' } },
